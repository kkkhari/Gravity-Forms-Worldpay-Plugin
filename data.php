...
class GFWorldPayData {

    public static function update_table() {
        global $wpdb;
        $table_name = self::get_worldpay_table_name();
    ...
    public static function get_worldpay_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_worldpay";
    }

    public static function get_transaction_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_worldpay_transaction";
    }
    ...
    public static function get_feed_by_form($form_id, $only_active = false){
        ...
        return apply_filters("gform_worldpay_get_feeds_{$form_id}", apply_filters('gform_worldpay_get_feeds', $results, $form_id), $form_id);
    }
    ...
    public static function update_feed($id, $form_id, $is_active, $setting){
        global $wpdb;
        // wp_die( es_preit( array( 'this is being called' ), false ) );
        $table_name = self::get_worldpay_table_name();
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_worldpay_table_name());
    }
